...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`/api/auth/${currentUser._id}`, {
        method: 'PUT',
        headers: {
  ...
  const handleSignOut = async () => {
    try {
        ...
        if (res.ok) {
            // Elimina cualquier token almacenado en el cliente
            localStorage.removeItem('token');

            // Despacha la acción de cierre de sesión exitoso
            ...
            window.location.href = '/signin'; // Cambia esto según tu estructura de rutas
        } else {
        ...
        // Muestra un mensaje en consola en caso de error
        console.error(error);
